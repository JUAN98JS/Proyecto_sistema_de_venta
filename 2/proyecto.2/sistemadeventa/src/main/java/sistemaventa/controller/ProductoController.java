...
public class ProductoController {
    ...
    public String listarProductos(Model model) {
        ...
        List<Map<String, Object>> productosConImagen = productos.stream().map(prod -> {
            ...
            p.put("id", prod.getCodigoProducto());
            p.put("nombre", prod.getNombre());
            p.put("tipo", prod.getTipo());
            p.put("modelo", prod.getModelo());
            p.put("precio", prod.getPrecio());
    ...
    @GetMapping("/buscar")
    public String buscarProducto(@RequestParam(value = "id", required = false) Integer codigoProducto, Model model) {
        ...
        if (producto == null) {
            model.addAttribute("error", " Producto con código " + codigoProducto + " no encontrado.");
            return "Editar_Producto";
        }
