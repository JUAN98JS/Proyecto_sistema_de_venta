...
public class ReporteController {
    ...
    public void descargarPdf(HttpServletResponse response) {
        ReporteInventarioDTO reporte = productoService.generarReporteInventario();
        List<Producto> productos = reporte.productos();
        ...
        try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
            ...
            table.addCell("Código");   // antes "ID", ahora mostramos código numérico
            ...
            for (Producto p : productos) {
                table.addCell(String.valueOf(p.getCodigoProducto()));  // ← código numérico
                table.addCell(p.getNombre());
                table.addCell(p.getTipo() == null ? "" : p.getTipo());
